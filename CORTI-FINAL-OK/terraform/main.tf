...
resource "scaleway_instance_server" "control_plane" {
  ...
  zone  = var.zone
  root_volume { size_in_gb = 50; volume_type = "sbs_volume"; delete_on_termination = true }
...
resource "scaleway_instance_server" "gpu_worker" {
  ...
  zone  = var.zone
  root_volume { size_in_gb = 100; volume_type = "sbs_volume"; delete_on_termination = true }
  private_network { pn_id = scaleway_vpc_private_network.main.id }
...
resource "scaleway_instance_server" "bastion" {
  ...
  zone  = var.zone
  root_volume { size_in_gb = 20; volume_type = "sbs_volume"; delete_on_termination = true }
  private_network { pn_id = scaleway_vpc_private_network.main.id }
  user_data = {
